package mr_immortalz.com.modelqq.wave;
...
import mr_immortalz.com.modelqq.UiUtils;
...
public class WaterRippleView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTotalWidth; i++) {
            ...
            // 绘制第一条水波纹
            canvas.drawLine(i, mTotalHeight - mResetOneYPositions[i] - 700, i,
                    mTotalHeight, mWavePaint);

            // 绘制第二条水波纹
            canvas.drawLine(i, mTotalHeight - mResetTwoYPositions[i] - 650, i,
                    mTotalHeight, mWavePaint);

            canvas.drawLine(i, mTotalHeight - mResetThreeYPositions[i] - 600, i,
                    mTotalHeight, mWavePaint);
        }
